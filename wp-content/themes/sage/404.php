...
<head>
    ...
    <title>NBC Custom Coating</title>
...
<nav class="navbar navbar-expand-lg navbar-dark fixed-top custom-nav" id="mainNav">
    <div class="container">
        <a class="navbar-brand js-scroll-trigger" href="index.html"><img src="img/NorthBasin.png" alt="logo" class="img-responsive"/> </a>
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav text-uppercase ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="about.html">about north basin</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link js-scroll-trigger" href="advantage.html">The North Basin Advantage</a>
                </li>
                <li class="nav-item">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <h3 class="section-subheading">Oops, sorry we can’t find that page!</h3>
                <p class="section-details">Either something went wrong or the page doesn’t exist anymore.</p>
                <div class="perfect-center">
                    <hr class="custom-hr" style="width:50%">
                </div>
                <a href="index.html" class="btn btn-warning">return to homepage</a>
            </div>
        </div>
    </div>
</section>
        ...
        <div class="row">
            ...
            <div class="col-md-2 flex-end">
                <div class="img-container">
                    <a href="index.html"><img src="img/NorthBasin.png" alt="North Basin Coating Inc" /></a>
                </div>
            </div>
            <div class="col-md-3">
